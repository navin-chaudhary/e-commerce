...
const FeatureProducts = () => {
  ...
  return (
    <div className="py-12 bg-[#f8fafc] text-black px-4 sm:px-8 lg:px-20">
      <div className="flex justify-between items-center mb-8 lg:mt-8">
        <h2 className="text-xl lg:text-4xl font-bold">Featured Products</h2>
        <Link 
          href={'/products'}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {products.map((product) => (
          <div key={product.id} className="border border-gray-300 rounded-xl shadow-md overflow-hidden relative bg-white hover:shadow-lg transition-shadow duration-300">
